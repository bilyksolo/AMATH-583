...
std::complex<double> f(std::complex<double> x)  { return std::pow(x , 5.0) + std::complex<double>{5.0, 0.0} * std::pow(x , 3.0) - std::complex<double>{ 13.0, 0.0 }; }  // f(x) = x^5 + 5.0 * x^3 - 13.0
std::complex<double> fp(std::complex<double> x) { return std::complex<double>{5.0, 0.0} * std::pow(x, 4.0) + std::complex<double>{15.0, 0.0} *  std::pow(x, 4.0); }  // derivative of f
